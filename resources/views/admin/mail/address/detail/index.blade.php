                            ...
                            <td class="text-left">
                                <div style="display: flex">
                                    <select name="field" class="form-item" style="width: 15%; margin-right: 10px;">
                                        ...
                                        <option value="name" {{ (request()->field ?? '') === 'name' ? 'selected' : '' }}>이름</option>
                                        <option value="email" {{ (request()->field ?? '') === 'email' ? 'selected' : '' }}>이메일</option>
                                        <option value="office" {{ (request()->field ?? '') === 'office' ? 'selected' : '' }}>근무처명</option>
                                    </select>
