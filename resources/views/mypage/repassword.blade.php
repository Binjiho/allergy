                ...
                <form id="forget-frm" action="" method="post" data-case="change-pw">
                    ...
                    <fieldset>
                        ...
                        <div class="bg-img-box bg-box">
                            <div class="img-wrap">
                                <img src="/assets/image/sub/img_password.png" alt="">
                            </div>
                            <div class="text-wrap">
                                <strong class="tit">비밀번호 변경</strong>
                                <ul class="list-type list-type-dot">
                                    <li>
                                        {{ $user->name_kr ?? '' }} 회원님의 개인정보보호를 위하여 6개월 이상 비밀번호를 변경하지 않은 경우 비밀번호 변경 안내를 하고 있습니다.
                                    </li>
                                    <li>
                                        비밀번호 변경을 원하지 않을 경우 <span class="highlights">다음에 변경하기</span> 버튼 클릭으로 1개월 동안 안내를 받지 않을 수 있습니다.
                                    </li>
                                    <li>
                        ...
                        <ul class="write-wrap">
                            ...
                            <li>
                                ...
                                <div class="form-con">
                                    ...
                                    <div class="help-text mt-10 text-blue">새 비밀번호를 재입력 해주세요.</div>
                                </div>
                            </li>
                        </ul>
                        <div class="help-text">
                            <ul class="list-type list-type-dot text-red mt-20">
                        ...
                        <div class="btn-wrap text-center">
                            <a href="javascript:;" id="next_check" class="btn btn-type1 color-type4">다음에 변경하기</a>
                            <button type="submit" class="btn btn-type1 color-type1">변경</button>
