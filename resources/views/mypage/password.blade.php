    ...
    <article class="sub-contents">
        <div class="sub-conbox inner-layer">
            <div class="confirm-wrap">
                <form id="forget-frm" action="" method="post" data-case="confirm-pw">
                    <input type="hidden" name="user_sid" value="{{ $user->sid ?? 0 }}" readonly>
                    <fieldset>
                        <legend class="hide">비밀번호 확인</legend>
                        <div class="confirm-info-box">
                            <img src="/assets/image/sub/img_confirm.png" alt="">
                            <p>
                                안전한 개인정보 확인을 위하여 <br>
                                접속하신 계정의 <span class="highlights">비밀번호를</span> 입력해주시기 바랍니다.
                            </p>
                        </div>
                        <ul class="write-wrap">
                            <li>
                        ...
                        <div class="btn-wrap text-center">
                            ...
                            <a href="javascript:$('#forget-frm').submit();" class="btn btn-type1 color-type1">확인</a>
                        </div>
                    </fieldset>
                </form>
            </div>
