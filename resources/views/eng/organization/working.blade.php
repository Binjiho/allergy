            ...
            <div class="tab-wrap">
                <div class="sub-tab-wrap">
                    <ul class="sub-tab-menu js-tab-menu">
                        <li class="on"><a href="#n">Severe atopic dermatitis</a></li>
                        <li><a href="#n">Drug Allergy</a></li>
                        <li><a href="#n">Immunotherapy / Allergen</a></li>
                        <li><a href="#n">Severe asthma</a></li>
                        <li><a href="#n">Anaphylaxis, Urticaria and Angioedema</a></li>
                        <li><a href="#n">Chronic cough</a></li>
                        <li><a href="#n">Allergic Rhinitis</a></li>
                    </ul>
                </div>
                ...
                <div class="sub-tab-con js-tab-con">
                    ...
                    <ul class="list-type list-type-bar">
                        <li>Defining patient characteristics of severe asthma by establishing a cohort</li>
                        <li>Promoting understanding of the etiology and mechanism of severe asthma</li>
                        <li>Developing safe and effective therapeutic strategies, preferrably in the concept of personalized medicine</li>
                    </ul>
                </div>
                <!-- //Severe asthma -->
