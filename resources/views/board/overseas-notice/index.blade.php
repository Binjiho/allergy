        ...
        <div class="sub-conbox inner-layer">
            ...
            <div class="sub-tab-wrap">
                ...
                <ul class="sub-tab-menu">
                    <li ><a href="{{ route('overseas') }}">국외학회 스케줄 및 진행상황</a></li>
                    <li ><a href="{{ route('overseas.guide') }}">지원 규정 및 선정 규정</a></li>
                    @if(!empty(request()->o_sid))
                        <li ><a href="{{ route('overseas.upsert',['o_sid'=>request()->o_sid, 'step'=>1]) }}">지원신청</a></li>
                    @endif
                    <li ><a href="{{ route('overseas.search') }}">신청내역 확인 및 결과보고</a></li>
                    <li class="on"><a href="{{ route('board',['code'=>'overseas-notice']) }}">공지사항</a></li>
                </ul>
            </div>
