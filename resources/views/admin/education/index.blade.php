...
{{--                            </td>--}}
        ...
        <div class="btn-wrap text-left">
            <a href="{{ route('education.upsert') }}" class="btn btn-type1 color-type19 call-popup" data-popup_name="workshop-upsert" data-width="1200" data-height="900">신규 행사 등록</a>
        </div>
            ...
            <table class="cst-table abs-info-table">
                ...
                @forelse($list as $row)
                    <tr data-sid="{{ $row->sid }}">
                        ...
                        <td>
                            <a href="{{ route('education.upsert', ['sid' => $row->sid]) }}" class="btn-admin call-popup" data-name="workshop-upsert" data-width="1200" data-height="900">
