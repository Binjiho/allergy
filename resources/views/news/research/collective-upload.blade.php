        ...
        <div class="popup-contents">
            ...
            <div class="popup-conbox">
                ...
                <div class="write-form-wrap">
                    ...
                    <form method="post" action="{{ route('news.data') }}" id="collective-upload" data-case="research-collective-create" onsubmit="return false;">
    ...
    <script>
        ...
        $(document).on('click', '#collective-upload input[type=submit]', function(e) {
            ...
            $.each(obj, function (key, data) {
                ...
                // if(isEmpty(excelData.regnum)) {
                //     submitCheck = false;
                //     actionAlert({'msg': '승인번호를 입력해주세요.'});
                //     return false;
                // }

                if(isEmpty(excelData.title)) {
                    submitCheck = false;
                    actionAlert({'msg': '연구과제를 입력해주세요.'});
                    return false;
                }
            ...
            if(submitCheck) {
                ...
                ajaxData.append('tab', $("[name='tab']").val());
