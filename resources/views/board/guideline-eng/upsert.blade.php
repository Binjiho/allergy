                            ...
                            <fieldset>
                                ...
                                <ul class="write-wrap">
                                    ...
                                    <li>
                                        ...
                                        <div class="form-con">
                                            <select name="year" id="yaer" class="form-item">
                                        ...
                                        <li>
                                            ...
                                            <div class="form-con">
                                                <div class="filebox">
                                                    ...
                                                    <input type="file" name="thumbnail" id="thumbnail" class="file-upload" accept=".jpg, .png, .gif, .pdf, .docx, .doc" data-accept="jpg|png|gif|pdf|docx|doc">
                                    ...
                                    @if($boardConfig['use']['file'])
                                        <li>
                                            <div class="form-tit"> 파일첨부 </div>
                                            <div class="form-con">
                                                <div class="filebox">
                                                    <input class="upload-name form-item" id="file1_name" name="file1_name" placeholder="파일첨부" readonly="readonly">
