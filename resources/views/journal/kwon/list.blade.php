        ...
        <div class="sub-conbox inner-layer">
            <div class="journal-conbox">
                ...
                <div class="btn-wrap text-right">
                    <a href="{{ route('journal.asKwon') }}" class="btn btn-type1 btn-round btn-reset color-type10"><span class="icon"><img src="/assets/image/sub/ic_btn_sch.png" alt=""></span>재검색</a>
                </div>
