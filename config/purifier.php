...
return [
    ...
    'settings'        => [
        'default' => [
            ...
            'HTML.Allowed'             => 'div[style|class|id],b,strong,table[style|border|cellpadding|cellspacing|align|summary|bgcolor|width|height],thead,tbody,tfoot,tr[style|width|height|border],td[style|colspan|rowspan|width|height],th[style|colspan|rowspan|width|height],colgroup,col[style|width|span],i,em,u,a[href|title|target|rel|style|class|id],ul[style|class|id],ol[style|class|id],li[style|class|id],p[style|class|id],br,span[style|class|id],img[usemap|width|height|alt|src|style|title|class|id],h1[style|class|id],h2[style|class|id],h3[style|class|id],h4[style|class|id],h5[style|class|id],h6[style|class|id],blockquote[style|class|id],pre[style|class|id],code[style|class|id],figcaption[style|class|id],figure[style|class|id],footer[style|class|id],header[style|class|id],section[style|class|id],article[style|class|id],nav[style|class|id],aside[style|class|id],address[style|class|id],s,var,sub,sup,mark,wbr,ins[cite|datetime],del[cite|datetime],hr[style|class|id],iframe[src|width|height|frameborder|allowfullscreen|style|class|id],video[src|width|height|controls|style|class|id],audio[src|controls|style|class|id],source[src|type],track[src|kind|srclang|label],canvas[width|height|style|class|id],map[name],area[shape|coords|href|alt]',
